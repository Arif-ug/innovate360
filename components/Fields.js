      ...
      <section className="bg-orange-50 dark:bg-gray-900 py-16 px-6 lg:px-10">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center border border-gray-200 dark:border-gray-700 transition transform hover:scale-105">
              <field.icon className="text-orange-500 text-4xl mx-auto" />
              <h3 className="text-xl dark:text-gray-50 font-bold mt-4">{field.title}</h3>
